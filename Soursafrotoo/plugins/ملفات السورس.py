...
@mody.ar_cmd(
    ...
    info={
        "header": "To list all plugins in Soursafrotoo.",
        "usage": "{tr}plugins",
    },
)
async def _(event):
    "To list all plugins in Soursafrotoo"
    cmd = "ls Soursafrotoo/plugins"
...
@mody.ar_cmd(
    ...
    info={
        "header": "To list all environment values in Soursafrotoo.",
        "description": "to show all heroku vars/Config values in your Soursafrotoo",
        "usage": "{tr}env",
    },
)
async def _(event):
    "To show all config values in Soursafrotoo"
    cmd = "env"
    o = (await _catutils.runcmd(cmd))[0]
    OUTPUT = (
