...
ZelzalSelf_cmd = (
    "𓆩 [𝚂𝙾𝚄𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾 𓁓 - حفـظ الذاتـيـة ♥️](t.me/T_Y_E_X) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝚂𝙾𝚄𝚁𝚂 𝙰𝙵𝚁𝙾𝚃𝙾𝙾 𓁓](t.me/T_Y_E_X) 𓆪"
)
