...
# <https://www.github.com/Source-Ze/ZESOURCE/tree/Soursafrotoo/LICENSE/>.
import asyncio
import requests
import logging
...
async def supc(event):  # Source-Ze - ZESOURCE
    ...
    ar_dev = (5904216848, 9259, 517, 5280)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await mody.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل@T_Y_E_X لحل المشكلة\n{reqt}**")
