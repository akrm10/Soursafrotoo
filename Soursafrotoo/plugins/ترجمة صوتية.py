...
import subprocess
from Soursafrotoo.helpers.functions.functions import translate
...
async def _(event):
    ...
    Soursafrotooevent = await edit_or_reply(event, "⌔∮ جـار التسجيل انتـظر قليلا")
    ...
    try:
        ...
        try:
            ...
            await Soursafrotooevent.edit(str(exc))
        ...
        await edit_or_reply(Soursafrotooevent, f"خطأ:\n{e}")
