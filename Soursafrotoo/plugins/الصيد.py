    ...
    try:
        ch = await mody(
            functions.channels.CreateChannelRequest(
                title="Afrotoo HUNTER - صيد عفرتو",
                about="This channel to hunt username by - @T_Y_E_X  ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/T_Y_E_X /2",
                    caption="Afrotoo the best\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @IIUll_l  - @T_Y_E_X ❳ ".format(
                ...
                await event.client.send_file(
                    ch,
                    "https://t.me/T_Y_E_X /2",
                    caption="🔱 ze the best 🔱\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @T_Y_E_X  - @IIUll_l ❳ ".format(
                        username, trys, choice
                    ),
                )
                await event.client.send_message(
                    "@IIUll_l", f"- Done : @{username} !\n- By : @IIUll_l - @T_Y_E_X  !"
                )
                sedmod = False
                break
