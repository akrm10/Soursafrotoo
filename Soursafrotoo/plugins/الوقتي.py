...
autopic_path = os.path.join(os.getcwd(), "Soursafrotoo", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "Soursafrotoo", "digital_pic.png")
digital_group_pic_path = os.path.join(os.getcwd(), "Soursafrotoo", "digital_group_pic.png")
autophoto_path = os.path.join(os.getcwd(), "Soursafrotoo", "photo_pfp.png")
auto_group_photo_path = os.path.join(os.getcwd(), "Soursafrotoo", "photo_pfp.png")

digitalpfp = Config.DIGITAL_PIC or "https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg"
digitalgrouppfp = Config.DIGITAL_GROUP_PIC or "https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg"
lMl10l = Config.TIME_JEP or ""
jep = Config.DEFAULT_PIC or "Soursafrotoo/helpers/styles/PaybAck.ttf"
