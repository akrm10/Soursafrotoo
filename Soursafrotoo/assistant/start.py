...
from Soursafrotoo import bot
from Soursafrotoo.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from Soursafrotoo.sql_helper.botusers_sql import add_me_in_db, his_userid
from Soursafrotoo.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/soursafrotooby")],
...
async def users(event):
    if event.query.user_id == bot.uid:
        ...
        with io.BytesIO(str.encode(users_list)) as tedt_file:
            tedt_file.name = "Soursafrotoo.txt"
