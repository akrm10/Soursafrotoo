...
ROZLOGO = "https://telegra.ph/file/04b2f1f1c808dc49db35b.jpg"
        ...
        if query.startswith("mody"):
            buttons = [
                (
                    ...
                    Button.url(" Soursafrotoo UsᴇʀBoᴛ", "https://t.me/T_Y_E_X"),
                )
            ]
            ...
            builder = event.builder
            troll = os.path.join("./Soursafrotoo", "troll.txt")
            try:
            ...
            user, txct = query.split(" ", 1)
            builder = event.builder
            secret = os.path.join("./Soursafrotoo", "secrets.txt")
            try:
            ...
            query = query[5:]
            builder = event.builder
            hide = os.path.join("./Soursafrotoo", "hide.txt")
            try:
            ...
            _result = main_menu()
            result = builder.article(
                title="© Soursafrotoo Help",
                description="Help menu for Soursafrotoo",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
